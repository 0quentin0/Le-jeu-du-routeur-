...
global taille_screen, gameover,score, angle,tir,menu,temps
taille_screen=None
gameover=False
tir=False
vitesse=3
...
def reset():
    global score,angle,menu,temp2,espacement,conterespacement,nbclone,temps
    temps=time.time()
...
while True:
    ...
    if menu=='play':
        ...
        for enemy in pygame.sprite.groupcollide(list_enemy,list_bullet,False,True):
            Recompence(enemy.rect.centerx,enemy.rect.centery)
            enemy.kill()
